...
#pragma warning restore CS0618
        ...
        {
            Action act = () => new ServerFactory(_clusterConnectionModeSwitch, _clusterConnectionMode, _directConnection, null, _connectionPoolFactory, _serverMonitorFactory, _eventSubscriber);
        ...
        {
            Action act = () => new ServerFactory(_clusterConnectionModeSwitch, _clusterConnectionMode, _directConnection, _settings, null, _serverMonitorFactory, _eventSubscriber);
        ...
        {
            Action act = () => new ServerFactory(_clusterConnectionModeSwitch, _clusterConnectionMode, _directConnection, _settings, _connectionPoolFactory, null, _eventSubscriber);
        ...
        {
            Action act = () => new ServerFactory(_clusterConnectionModeSwitch, _clusterConnectionMode, _directConnection, _settings, _connectionPoolFactory, _serverMonitorFactory, null);
        ...
        {
            var subject = new ServerFactory(_clusterConnectionModeSwitch, _clusterConnectionMode, _directConnection, _settings, _connectionPoolFactory, _serverMonitorFactory, _eventSubscriber);
