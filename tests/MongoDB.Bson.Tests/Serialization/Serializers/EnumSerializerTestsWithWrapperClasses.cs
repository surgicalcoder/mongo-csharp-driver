...
{
    public class EnumSerializerWithWrapperClassesTests
    {
        ...
        public class WrappedEnumWithDefaultRepresentation<TEnum> where TEnum : struct, Enum
        {
            public TEnum x { get; set; }
        }

        public class WrappedEnumWithInt32Representation<TEnum> where TEnum : struct, Enum
        {
            [BsonRepresentation(BsonType.Int32)]
            public TEnum x { get; set; }
        }

        public class WrappedEnumWithInt64Representation<TEnum> where TEnum : struct, Enum
        {
            [BsonRepresentation(BsonType.Int64)]
            public TEnum x { get; set; }
        }

        public class WrappedEnumWithStringRepresentation<TEnum> where TEnum : struct, Enum
        {
            ...
            where TEnum : struct, Enum
        {
            ...
            var exception = Record.Exception(() => BsonSerializer.Deserialize<WrappedEnumWithDefaultRepresentation<TEnum>>(bson));
        ...
        public void Deserialize_should_throw_on_overflow<TEnum>(TEnum _, string json)
            where TEnum : struct, Enum
        {
            var exception = Record.Exception(() => BsonSerializer.Deserialize<WrappedEnumWithDefaultRepresentation<TEnum>>(ToBson(json)));
            ...
            where TEnum : struct, Enum
        {
            ...
            {
                case (BsonType)0: exception = Record.Exception(() => bson = new WrappedEnumWithDefaultRepresentation<TEnum> { x = value }.ToBson()); break;
                case BsonType.Int32: exception = Record.Exception(() => bson = new WrappedEnumWithInt32Representation<TEnum> { x = value }.ToBson()); break;
                case BsonType.Int64: exception = Record.Exception(() => bson = new WrappedEnumWithInt64Representation<TEnum> { x = value }.ToBson()); break;
                case BsonType.String: exception = Record.Exception(() => bson = new WrappedEnumWithStringRepresentation<TEnum> { x = value }.ToBson()); break;
                default: throw new Exception($"Unexpected representation: {representation}.");
            }
            ...
            else
            {
                ...
                switch (representation)
                {
                    case (BsonType)0: deserialized = BsonSerializer.Deserialize<WrappedEnumWithDefaultRepresentation<TEnum>>(bson).x; break;
                    case BsonType.Int32: deserialized = BsonSerializer.Deserialize<WrappedEnumWithInt32Representation<TEnum>>(bson).x; break;
                    case BsonType.Int64: deserialized = BsonSerializer.Deserialize<WrappedEnumWithInt64Representation<TEnum>>(bson).x; break;
                    case BsonType.String: deserialized = BsonSerializer.Deserialize<WrappedEnumWithStringRepresentation<TEnum>>(bson).x; break;
                    default: throw new Exception($"Unexpected representation: {representation}.");
                }
