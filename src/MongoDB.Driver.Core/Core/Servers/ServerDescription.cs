    ...
    public sealed class ServerDescription : IEquatable<ServerDescription>
    {
        ...
        public override string ToString()
        {
            return new StringBuilder()
                ...
                .AppendFormatIf(!_lastHeartbeatTimestamp.HasValue, "LastHeartbeatTimestamp:null")
                .AppendFormatIf(_lastHeartbeatTimestamp.HasValue, ", LastHeartbeatTimestamp: \"{0:yyyy-MM-ddTHH:mm:ss.fffffffK}\"", _lastHeartbeatTimestamp.Value)
