...
#pragma warning restore 618
        ...
        public override string ToString()
        {
            ...
            if (_tlsDisableCertificateRevocationCheck.HasValue)
            {
                query.AppendFormat("tlsDisableCertificateRevocationCheck={0};", _tlsDisableCertificateRevocationCheck.Value);
            }
